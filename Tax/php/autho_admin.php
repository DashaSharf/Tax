...
if( isset($data['log_in']) )
{
  ...
  $_SESSION["user"] = $data['login'];
	...
	if($employees)
	{
     ...
     {
       echo "Выполняется вход <a href='http://localhost/Tax/php/ad_ac.php'></a>";
...
<head>
	...
	<title>Обновление документации ФНС/Вход администратора</title>
	<link rel="stylesheet" type="text/css" href="../css/autho_admin.css" media="all" >
...
<div class="vhod">
 <form action="http://localhost/Tax/php/autho_admin.php" method="POST">
